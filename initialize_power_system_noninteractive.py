...
def print_usage():
    print("电力管理系统快速初始化工具")
    print("用法: python initialize_power_system_noninteractive.py [操作]")
    print("操作:")
    print("  init       - 初始化系统数据")
    print("  reduce10   - 应用10%电力削减")
    print("  reduce25   - 应用25%电力削减")
    print("  reduce50   - 应用50%电力削减")
    print("  rotate     - 生成并执行轮换计划")
    print("  demo       - 运行完整演示流程")
...
if __name__ == "__main__":
    ...
    if action == "init":
        initialize_system()
    elif action == "reduce10":
        apply_power_reduction(10)
    elif action == "reduce25":
