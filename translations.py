...
translations = {
    # 加密货币投资组合页面 / Crypto Portfolio page
    "crypto_portfolio_title": "加密货币投资组合",
    "crypto_portfolio_management": "加密货币投资组合管理",
    ...
    "daily_change": "24小时变化",
    "actions": "操作",
    "no_assets_message": "当前没有资产。点击'添加资产'开始构建您的投资组合。",
    "total": "总计",
    "portfolio_analysis": "投资组合分析",
    "allocation_chart": "资产分配图",
    "risk_assessment": "风险评估",
    "diversification": "多样化",
    "volatility": "波动性",
    "overall_risk": "总体风险",
    "portfolio_optimization": "投资组合优化",
    "add_assets_recommendation": "添加更多资产以获得投资组合优化建议",
    "portfolio_performance": "投资组合表现",
    "rebalancing_suggestions": "再平衡建议",
    "add_more_assets": "添加更多资产以获得再平衡建议",
    "crypto_id": "加密货币ID",
    "current_allocation": "当前分配",
    "suggested_allocation": "建议分配",
    "action_required": "所需操作",
    "apply_suggestions": "应用建议",
    "add_crypto_asset": "添加加密货币资产",
    "select_cryptocurrency": "选择加密货币",
    "choose_crypto": "请选择加密货币",
    "purchase_price": "购买价格",
    "purchase_price_help": "购买时的价格（美元）。如果不知道，将使用当前价格。",
    "purchase_date": "购买日期",
    "notes": "备注",
    "edit_crypto_asset": "编辑加密货币资产",
    "delete": "删除",
    "save_changes": "保存更改",
    "cryptocurrency": "加密货币",
