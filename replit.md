...
## Changelog  
- June 30, 2025: **COMPLETED** - Investment decision center UI optimization: removed operational performance metrics (algorithm efficiency, power efficiency, uptime, temperature) not relevant for potential investment customers, relocated real-time market data (BTC price $108,653, network hashrate 988.39 EH/s, fear & greed index 66) from dashboard to Market Data tab for better organization
