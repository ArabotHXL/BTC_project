...
- **Main Dashboard 500 Error Fix (Aug 22)**: Fixed /main page 500 error caused by incorrect batch calculator URL routing in dashboard_home.html and missing API functions in api_client.py. Added get_btc_price_with_fallback() and get_network_stats_with_fallback() functions. Batch calculator now accessible at /batch-calculator with full functionality.
